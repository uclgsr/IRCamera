...
\begin{document}
    ...
    \begin{figure}[htbp]
        \centering
        \fbox{\textit{[See docs/thesis-diagrams/chapter2-gsr-thermal-examples.md for Mermaid visualizations]}}
    ...
    \begin{table}[htbp]
        ...
        \fbox{\textit{[See docs/thesis-diagrams/chapter2-related-systems-comparison.md for detailed comparison table]}}
    ...
    \begin{table}[htbp]
        ...
        \fbox{\textit{[See docs/thesis-diagrams/chapter2-hardware-specs-table.md for detailed specifications table]}}
