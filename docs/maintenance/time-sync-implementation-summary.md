...
The issue stated that time synchronization was completely dormant - no actual NTP-style protocol exchange was happening,
and all sensor data was timestamped using only the Android device's clock without any alignment to the PC master clock.
