...
## Overview
This document identifies deprecated Java patterns and Android API usage in the IRCamera repository that should be migrated to modern Kotlin/AndroidX alternatives.
