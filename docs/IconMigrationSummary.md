...
The codebase is now modern, maintainable, and follows Android best practices while retaining the specialized visuals needed for the IRCamera application's unique features.
