...
**Why:** Using port 0 assigned a random ephemeral port, making it difficult for the PC to connect. Using the protocol's default port (8080) makes connections predictable.
...
The PC networking and control interface was already fully implemented in the codebase. Only 3 minimal changes were needed to activate it:
