...
This document consolidates all networking, session orchestration, and time synchronization implementation details for
the IRCamera platform.
...
This consolidated implementation provides a robust, scalable foundation for multi-modal physiological sensing research
