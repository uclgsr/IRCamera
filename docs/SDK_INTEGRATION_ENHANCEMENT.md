...
## Overview
This document describes the enhanced integration of Topdon TC001 (Thermal Camera) and Shimmer3 GSR+ SDKs to ensure full utilization of their capabilities through user-configurable settings.
...
The Shimmer SDK supports sampling rates from 1 Hz to 512 Hz. We now dynamically configure this based on GSRSettingsRepository:
