...
This prioritization ensures that core functionality remains robust while gradually expanding capabilities based on user needs and research requirements.
