...
This table provides a quick reference to the capabilities and constraints of the chosen hardware, helping readers
understand the technical context and component selection rationale.
