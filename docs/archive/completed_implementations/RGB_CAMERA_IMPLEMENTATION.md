...
The implementation is production-ready for Samsung S22 devices and provides graceful fallbacks for other Android
devices, making it suitable for the multi-modal sensor recording thesis project.