...
/**
 * Comprehensive unit tests for libmatrix module using Robolectric
 * Tests matrix operations, mathematical computations, and utility functions
 */
...
class LibMatrixModuleTest {
    ...
    @Test
    fun testMatrixOperations() = runTest {
    ...
    @Test
    fun testMatrixTransposition() = runTest {
        ...
        // Transpose matrix
        val transposedMatrix = Array(originalMatrix[0].size) { col ->
    ...
    @Test
    fun testMatrixMultiplication() = runTest {
    ...
    @Test
    fun testVectorOperations() = runTest {
        // Test vector operations
        val vectorA = floatArrayOf(1.0f, 2.0f, 3.0f)
        val vectorB = floatArrayOf(4.0f, 5.0f, 6.0f)
        
        // Test vector addition
        val vectorSum = FloatArray(vectorA.size) { i ->
            vectorA[i] + vectorB[i]
        }
        
        assertArrayEquals("Vector sum should be correct", 
            floatArrayOf(5.0f, 7.0f, 9.0f), vectorSum, 0.001f)
    ...
    @Test
    fun testMatrixDeterminant() = runTest {
        ...
        val determinant3x3 = matrix3x3[0][0] * (matrix3x3[1][1] * matrix3x3[2][2] - matrix3x3[1][2] * matrix3x3[2][1]) -
    ...
    @Test
    fun testMatrixTransformations() = runTest {
    ...
    @Test
    fun testRotationMatrix() = runTest {
