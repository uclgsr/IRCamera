            ...
            with open(filename, 'w', newline='') as csvfile:
                ...
                for device_id, data_points in self.gsr_data.items():
                    for timestamp, gsr_value in data_points:
                        writer.writerow([timestamp, device_id, gsr_value, self.current_session or "unknown"])
    ...
    def update_gsr_plot(self):
        ...
        for device_id, data_points in self.gsr_data.items():
            if data_points:
                ...
                self.gsr_plot.plot(rel_timestamps, gsr_values, pen=pg.mkPen(width=2), name=device_id)
