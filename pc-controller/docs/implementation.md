...
The PC Controller is a comprehensive desktop application that serves as the central Hub in the IRCamera Multi-Modal Thermal Sensing Platform's Hub-and-Spoke architecture. This document covers all implementation details, features, and integration status.
