...
def test_discovery_callback_events():
    ...
    try:
        from ircamera_pc.core.device_manager import DeviceManager
        from ircamera_pc.network.discovery import NetworkDiscoveryService, DiscoveredDevice, DeviceType
...
def test_register_device_signature():
    ...
    try:
        from ircamera_pc.core.device_manager import DeviceRegistry, DeviceInfo, DeviceType, DeviceConnectionState
