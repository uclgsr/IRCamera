...
class PCControllerTest:
    ...
    def connect_to_android(self) -> bool:
        ...
        try:
            print(f"Attempting to connect to Android device at {self.android_ip}:{self.port}")
            ...
            print("❌ Connection refused - Android app may not be running or not listening on this port")
            return False
