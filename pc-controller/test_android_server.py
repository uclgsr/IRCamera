...
class AndroidServerTester:
    ...
    def connect_to_android(self) -> bool:
        ...
        try:
            print(f"🔌 Connecting to Android NetworkServer at {self.android_ip}:{self.port}")
    ...
    def test_device_registration(self) -> bool:
        ...
        if self.send_message(registration_message):
            ...
            if response and response.get("message_type") == "enhanced_registration_ack":
                ...
                print(f"❌ Device registration failed - unexpected response: {response}")
                return False
...
def main():
    ...
    try:
        ...
        if not tester.connect_to_android():
            ...
            print("In the actual implementation, the NetworkServer starts automatically")
        ...
        if passed == total:
            print("🎉 All tests passed! NetworkServer implementation is working correctly.")
            return 0
        else:
