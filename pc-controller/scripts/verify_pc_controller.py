...
def verify_file_structure():
    ...
    backend_pattern = str(
        pc_controller_root / 'native_backend' / 'enhanced_native_backend*.so') if sys.platform != 'win32' else str(
        pc_controller_root / 'native_backend' / 'enhanced_native_backend*.pyd')
