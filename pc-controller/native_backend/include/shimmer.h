...
// Utility functions for data processing
    namespace processing {
        ...
        std::vector<double>
        apply_lowpass_filter(const std::vector<double> &data, double cutoff_hz, double sample_rate);
        ...
        // Artifact detection
        std::vector<bool>
        detect_motion_artifacts(const std::vector<double> &gsr_data, double threshold = 2.0);
