package mpdc4gsr.feature.capture.gsr.data.source
...
import mpdc4gsr.core.hardware.gsr.toGsrSamplePayload
...
class GSRDeviceDataSourceImpl
    ...
    constructor(
        ...
        override fun isConnected(deviceAddress: String): Boolean = gsrDeviceManager.isDeviceConnected(deviceAddress)
