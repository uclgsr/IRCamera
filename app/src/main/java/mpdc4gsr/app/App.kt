...
import mpdc4gsr.core.designsystem.InitUtils.initLog
import mpdc4gsr.core.designsystem.InitUtils.initReceiver
import mpdc4gsr.core.designsystem.InitUtils.initUM
...
class App : BaseApplication() {
    ...
    override fun onCreate() {
        ...
        mpdc4gsr.core.common.telemetry.PerformanceMetrics
            .initialize()
        ...
        mpdc4gsr.core.common.telemetry.TelemetryManager
            .initialize(this)
            ...
            object : Application.ActivityLifecycleCallbacks {
                ...
                override fun onActivityStarted(activity: Activity) {
                    ...
                    if (foregroundActivityCount == 1) {
                        mpdc4gsr.core.common.telemetry.TelemetryManager.trackEvent(
                            "app_foreground",
                ...
                override fun onActivityResumed(activity: Activity) {
                    currentActivityRef = WeakReference(activity)
                    mpdc4gsr.core.common.telemetry.TelemetryManager.trackScreenView(
