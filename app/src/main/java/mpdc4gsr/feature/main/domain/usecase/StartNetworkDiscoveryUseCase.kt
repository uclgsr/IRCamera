...
class StartNetworkDiscoveryUseCase @Inject constructor(
    private val networkRepository: NetworkRepository
) {
    suspend operator fun invoke(): List<NetworkClient.ControllerInfo> {
        return networkRepository.discoverControllers()
    }
}
