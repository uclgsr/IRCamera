...
import mpdc4gsr.feature.connectivity.ui.ConnectScreen
import mpdc4gsr.feature.connectivity.ui.NetworkSettingsScreen
import mpdc4gsr.feature.control.settings.ui.*
import mpdc4gsr.feature.capture.thermal.ui.*
            ...
            SettingsScreen(
                ...
                onNavigateToRecordingSettings = {
                    navController.navigate(
                        mpdc4gsr.core.designsystem.navigation.UnifiedRoute.RecordingSettings.route,
                    )
                },
                onNavigateToStorageSettings = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.StorageSettings.route) },
                onNavigateToSyncSettings = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.SyncSettings.route) },
                onNavigateToCalibration = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.Calibration.route) },
                onNavigateToNetworkSettings = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.NetworkSettings.route) },
                onNavigateToDiagnostics = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.Diagnostics.route) },
                onNavigateToAppInfo = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.AppInfo.route) },
                onNavigateToPrivacyPolicy = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.PrivacyPolicy.route) },
                onNavigateToHelp = { navController.navigate(mpdc4gsr.core.designsystem.navigation.UnifiedRoute.Help.route) },
            )
        }
