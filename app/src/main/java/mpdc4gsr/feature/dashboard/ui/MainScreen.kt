...
import mpdc4gsr.feature.dashboard.domain.model.SensorStatus
import mpdc4gsr.feature.dashboard.presentation.MainActivityViewModel
import mpdc4gsr.feature.dashboard.presentation.MainUiAction
import mpdc4gsr.feature.dashboard.presentation.MainUiState
import mpdc4gsr.feature.dashboard.presentation.SensorOverviewState
...
fun MainRoute(
    ...
    onNavigateToSensor: (mpdc4gsr.core.designsystem.model.SensorType) -> Unit = {},
...
private fun SensorDashboardTab(
    state: MainUiState,
    onAction: (MainUiAction) -> Unit,
    onSensorClick: (mpdc4gsr.core.designsystem.model.SensorType) -> Unit = {},
    modifier: Modifier = Modifier,
) {
    ...
    val gsrActionHandler =
        remember(onAction) {
            { action: mpdc4gsr.core.designsystem.model.GSRAction ->
                onAction(MainUiAction.PerformGsrAction(action))
            }
        }
    val thermalActionHandler =
        remember(onAction) {
            { action: mpdc4gsr.core.designsystem.model.ThermalAction ->
                onAction(MainUiAction.PerformThermalAction(action))
            }
        }
    val rgbActionHandler =
        remember(onAction) {
            { action: mpdc4gsr.core.designsystem.model.CameraAction ->
    ...
    Column(
        ...
        mpdc4gsr.core.designsystem.components.sensors.GSRSensorCard(
            state = gsrSensorUiState,
            onStateChange = {},
            onClick = { onSensorClick(mpdc4gsr.core.designsystem.model.SensorType.GSR) },
            onAction = gsrActionHandler,
        )
        mpdc4gsr.core.designsystem.components.sensors.ThermalSensorCard(
            state = thermalSensorUiState,
            onStateChange = {},
            onClick = { onSensorClick(mpdc4gsr.core.designsystem.model.SensorType.ThermalIR) },
            onAction = thermalActionHandler,
        )
        mpdc4gsr.core.designsystem.components.sensors.RGBCameraSensorCard(
            state = rgbSensorUiState,
            onStateChange = {},
            onClick = { onSensorClick(mpdc4gsr.core.designsystem.model.SensorType.RGBCamera) },
...
private fun mapSensorStatusToUiState(status: SensorStatus): mpdc4gsr.core.designsystem.model.SensorState =
    when (status) {
        SensorStatus.DISCONNECTED -> mpdc4gsr.core.designsystem.model.SensorState.Disconnected
        SensorStatus.CONNECTING -> mpdc4gsr.core.designsystem.model.SensorState.Connecting
        SensorStatus.CONNECTED -> mpdc4gsr.core.designsystem.model.SensorState.Connected
        SensorStatus.STREAMING -> mpdc4gsr.core.designsystem.model.SensorState.Streaming
        SensorStatus.ERROR -> mpdc4gsr.core.designsystem.model.SensorState.Error
        SensorStatus.SIMULATION -> mpdc4gsr.core.designsystem.model.SensorState.Simulation
    }
