...
import mpdc4gsr.feature.connectivity.domain.usecase.ConnectToControllerUseCase
import mpdc4gsr.feature.connectivity.domain.usecase.DisconnectUseCase
import mpdc4gsr.feature.connectivity.domain.usecase.DiscoverControllersUseCase
import mpdc4gsr.feature.connectivity.domain.usecase.ObserveConnectionStateUseCase
...
class DevicePairingViewModel @Inject constructor(
    ...
    val connectionState = observeConnectionStateUseCase()
        .stateIn(
            ...
            initialValue = mpdc4gsr.feature.connectivity.domain.model.ConnectionState.Disconnected
        )
