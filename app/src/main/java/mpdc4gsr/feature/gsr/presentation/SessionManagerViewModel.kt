...
class SessionManagerViewModel
    ...
    constructor(
        ...
        private suspend fun updateStorageInfo() {
            try {
                ...
                mpdc4gsr.core.utils.AppLogger
                    .e("SessionManagerViewModel", "Unexpected Exception in SessionManagerViewModel catch block", e)
            }
        }
                            ...
                            if (sessionDir.isDirectory && sessionDir.name.startsWith("session_")) {
                                try {
                                    ...
                                    mpdc4gsr.core.utils.AppLogger.e(
                                        ...
                                        "Unexpected Exception in SessionManagerViewModel catch block",
                                        e,
                                    )
                                }
                            }
        ...
        private fun calculateSessionDataInfo(
            sessionDir: File,
