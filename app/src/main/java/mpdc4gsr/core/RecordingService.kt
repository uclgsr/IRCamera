...
class RecordingService : LifecycleService() {
    ...
    companion object {
        ...
        const val ACTION_START_RECORDING = "mpdc4gsr.START_RECORDING"
        const val ACTION_STOP_RECORDING = "mpdc4gsr.STOP_RECORDING"
        const val ACTION_ADD_SYNC_MARKER = "mpdc4gsr.ADD_SYNC_MARKER"
        const val ACTION_START_SERVER = "mpdc4gsr.START_SERVER"
        const val ACTION_STOP_SERVER = "mpdc4gsr.STOP_SERVER"
        const val ACTION_CONNECT_PC = "mpdc4gsr.CONNECT_PC"
        const val ACTION_DISCONNECT_PC = "mpdc4gsr.DISCONNECT_PC"
        const val ACTION_START_DISCOVERY = "mpdc4gsr.START_DISCOVERY"
