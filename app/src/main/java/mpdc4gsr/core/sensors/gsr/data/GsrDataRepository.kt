...
class GsrDataRepository : BaseRepository() {
    ...
    fun getDataStream(deviceId: String): Flow<BaseRepository.Result<GsrReading>> = flow {
    ...
    fun getHistoricalData(
        ...
        val cacheKey = \"gsr_${'$'}{sessionId}_${'$'}startTime_${'$'}endTime\"
    ...
    // Session management
    fun getSessions(deviceId: String): Flow<BaseRepository.Result<List<GsrSession>>> = safeFlow {
    ...
    private fun generateReading(deviceId: String, counter: Int): GsrReading {
