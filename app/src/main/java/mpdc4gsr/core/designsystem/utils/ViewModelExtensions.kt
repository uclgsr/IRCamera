...
data class ComposeConnectionStates(
    val thermalCamera: mpdc4gsr.core.designsystem.ConnectionState,
    val gsrSensor: mpdc4gsr.core.designsystem.ConnectionState,
    val bleConnection: mpdc4gsr.core.designsystem.ConnectionState,
)
