            ...
            runOnUiThread {
                if (success) {
                    ...
                    if (gsrSensor != null) {
                        ...
                        binding.gsrStatusText.setTextColor(ContextCompat.getColor(this@GSRQuickRecordingActivity, R.color.gsr_recording_active))
                    }
                } else {
                ...
                runOnUiThread {
                    when (state) {
                        com.topdon.tc001.controller.RecordingState.RECORDING -> {
                            ...
                            binding.statusText.setTextColor(ContextCompat.getColor(this@GSRQuickRecordingActivity, R.color.gsr_recording_active))
                        }
