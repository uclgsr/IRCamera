...
/**
 * BaseScreenBindingActivity - Common lifecycle patterns for View-based activities
 * 
 ...
 */
abstract class BaseScreenBindingActivity<T : ViewDataBinding> : BaseBindingActivity<T>() {
