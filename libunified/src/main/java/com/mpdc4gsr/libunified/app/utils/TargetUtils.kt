...
object TargetUtils {
    ...
    fun calculateTargetArea(observeBean: ObserveBean): Float = observeBean.observeWidth * observeBean.observeHeight
        ...
        when {
            ...
            targetType == ObserveBean.TYPE_TARGET_CIRCLE -> {
                when (targetColorType) {
                    ...
                    ObserveBean.TYPE_TARGET_COLOR_RED ->
                        when (targetMeasureMode) {
