...
This comprehensive index provides quick navigation to all documentation across the IRCamera
...
2. **[COMPREHENSIVE_TESTING_GUIDE.md](COMPREHENSIVE_TESTING_GUIDE.md)** - Complete testing
...
- **[pc-controller/legacy_implementation/README.md](pc-controller/legacy_implementation/README.md)
  ** - Historical
  reference
...
- **[testing-suite/emulators/README.md](testing-suite/emulators/README.md)** - Emulator testing
  setup
...
1. [docs/COMPREHENSIVE_ARCHITECTURE_DIAGRAMS.md](docs/COMPREHENSIVE_ARCHITECTURE_DIAGRAMS.md) -
   System design
2. [app/src/main/java/mpdc4gsr/permissions/README.md](app/src/main/java/mpdc4gsr/permissions/README.md) -
   Permissions
   system
...
3. [testing-suite/testing-suite/results/](testing-suite/testing-suite/results/) - Quantitative
   results
...
- **Check [testing-suite/testing-suite/results/](testing-suite/testing-suite/results/)** for
  quantitative evidence

This index is maintained as part of the documentation consolidation process and reflects the current
state of the
