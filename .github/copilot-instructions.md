...
- ALWAYS UPDATE CHANGELOG.MD (APPEND TO END WITH COMMIT ID TO AVOID MERGE CONFLICT)
- ALWAYS UPDATE BACKLOG.MD (APPEND TO END WITH COMMIT ID TO AVOID MERGE CONFLICT)
- ALWAYS UPDATE README.MD (APPEND TO END WITH COMMIT ID TO AVOID MERGE CONFLICT)
- ALWAYS UPDATE MERMAID_DIAGRAMS.MD (APPEND TO END WITH COMMIT ID TO AVOID MERGE CONFLICT)
