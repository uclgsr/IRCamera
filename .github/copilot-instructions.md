...
- Install dependencies: `pip3 install PyQt6 loguru zeroconf numpy pandas h5py pyqtgraph scipy opencv-python bleak psutil`
...
The Android build is currently non-functional due to missing dependencies, but the PC controller has a comprehensive MVP implementation that can be tested and developed independently.
