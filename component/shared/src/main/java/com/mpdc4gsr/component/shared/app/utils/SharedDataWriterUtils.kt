...
class SharedDataWriterUtils(
    ...
    companion object {
        private const val TAG = "SharedDataWriter"
        ...
        ): SharedDataWriterUtils = SharedDataWriterUtils(outputFile, bufferSize, flushIntervalMs, maxQueueSize)
    }
}
