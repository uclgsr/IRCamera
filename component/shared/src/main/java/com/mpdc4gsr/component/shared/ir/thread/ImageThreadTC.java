package com.mpdc4gsr.component.shared.ir.thread;
...
import com.mpdc4gsr.component.shared.app.utils.SharedColorUtils;
import com.mpdc4gsr.component.shared.ir.bean.ColorRGB;
import com.mpdc4gsr.component.shared.ir.utils.IRImageHelp;
import com.mpdc4gsr.component.shared.ir.utils.JNITools;
            ...
            synchronized (syncimage.dataLock) {
                if (syncimage.start) {
                    if (irImageHelp.getColorList() != null) {
                        ...
                        LibIRProcess.convertYuyvMapToARGBPseudocolor(imageSrc, imageHeight * imageWidth, SharedColorUtils.changePseudocodeModeByOld(pseudocolorMode), imageARGB);
                    }
