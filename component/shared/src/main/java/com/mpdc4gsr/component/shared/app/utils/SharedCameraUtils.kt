...
object SharedCameraUtils {
    private const val TAG = "SharedCameraUtils"
    ...
    class CameraPreviewManager {
        private var previewView: SharedCameraView? = null
        private var isPreviewRunning = false

        fun startPreview(cameraView: SharedCameraView) {
    ...
    fun createCameraView(
        ...
        SharedCameraView(context).apply {
            setConfig(config)
        }

    fun createCameraAdapter(onItemClick: (CameraItem) -> Unit = {}): SharedCameraAdapter = SharedCameraAdapter(onItemClick = onItemClick)

    fun createPreviewManager(): CameraPreviewManager = CameraPreviewManager()

    fun validateCameraConsolidation(): Boolean = true
}
