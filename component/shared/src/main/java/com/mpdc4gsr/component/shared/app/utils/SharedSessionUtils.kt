...
object SharedSessionUtils {
    ...
    fun getRGBDirectory(sessionDir: File): File = File(sessionDir, RGB_SUBDIR).apply { mkdirs() }

    fun getThermalDirectory(sessionDir: File): File = File(sessionDir, THERMAL_SUBDIR).apply { mkdirs() }

    fun getShimmerDirectory(sessionDir: File): File = File(sessionDir, SHIMMER_SUBDIR).apply { mkdirs() }

    fun getMetadataDirectory(sessionDir: File): File = File(sessionDir, METADATA_SUBDIR).apply { mkdirs() }
