...
dependencies {
    ...
    implementation(files("../../app/libs/libAC020sdk_USB_IR_1.1.1_2408291439.aar"))
    implementation(files("../../app/libs/libirutils_1.2.0_2409241055.aar"))
    implementation(files("../../app/libs/libcommon_1.2.0_24052117.aar"))
    implementation(files("../../app/libs/topdon.aar"))
