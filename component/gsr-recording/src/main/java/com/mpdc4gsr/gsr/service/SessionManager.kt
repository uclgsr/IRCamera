...
class SessionManager private constructor(context: Context) {
    ...
    fun createSession(
        ...
        sessionListeners.forEach { it.onSessionCreated(session) }        return session
    }
    ...
    fun updateSession(
        ...
        updates(session)
        sessionListeners.forEach { it.onSessionUpdated(session) }        return true
    }
    ...
    fun completeSession(sessionId: String): SessionInfo? {
        ...
        sessionListeners.forEach { it.onSessionCompleted(session) }}ms")
        return session
    }
