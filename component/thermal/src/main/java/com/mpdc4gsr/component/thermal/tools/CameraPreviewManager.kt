...
import com.mpdc4gsr.component.shared.ui.camera.CameraPreviewManager as SharedCameraPreviewManager

class CameraPreviewManager private constructor() {
    private val delegate = SharedCameraPreviewManager.getInstance()
