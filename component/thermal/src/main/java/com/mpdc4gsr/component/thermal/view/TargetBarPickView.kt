    ...
    constructor(
        ...
        val typedArray =
            context.obtainStyledAttributes(
                attrs,
                com.mpdc4gsr.component.shared.R.styleable.BarPickView,
                0,
                0,
            )
        max = typedArray.getInt(com.mpdc4gsr.component.shared.R.styleable.BarPickView_android_max, 100)
        min = typedArray.getInt(com.mpdc4gsr.component.shared.R.styleable.BarPickView_barMin, 0)
        progress =
            typedArray
                .getInt(com.mpdc4gsr.component.shared.R.styleable.BarPickView_android_progress, min)
                .coerceAtMost(max)
                .coerceAtLeast(min)
        barSize =
            typedArray.getInt(
                com.mpdc4gsr.component.shared.R.styleable.BarPickView_barSize,
                4.dpToPx(context),
            )
        rotate =
            typedArray.getInt(com.mpdc4gsr.component.shared.R.styleable.BarPickView_barOrientation, 0)
        labelText =
            typedArray.getString(com.mpdc4gsr.component.shared.R.styleable.BarPickView_barLabel) ?: ""
        val textSize =
            typedArray.getDimensionPixelSize(
                com.mpdc4gsr.component.shared.R.styleable.BarPickView_android_textSize,
                13.spToPx(context),
            )
        typedArray.recycle()
