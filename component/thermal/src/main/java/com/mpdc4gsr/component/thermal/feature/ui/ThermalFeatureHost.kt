package com.mpdc4gsr.component.thermal.feature.ui
...
import com.mpdc4gsr.component.thermal.feature.ui.components.ThermalStatusBanner
...
@Composable
private fun FeatureContainer(descriptor: com.mpdc4gsr.component.thermal.feature.navigation.ThermalFeatureDescriptor) {
    when (val content = descriptor.content) {
        is com.mpdc4gsr.component.thermal.feature.navigation.ThermalFeatureContent.Compose -> {
            content.body()
        }

        is com.mpdc4gsr.component.thermal.feature.navigation.ThermalFeatureContent.FragmentHost -> {
