...
import com.mpdc4gsr.component.shared.R as LibUiR
            ...
            if (holder is ItemView) {
                ...
                holder.name.setTextColor(
                    if (position == selected) {
                        ContextCompat.getColor(context, com.mpdc4gsr.component.shared.R.color.white)
                    } else {
                        ContextCompat.getColor(
                            context,
                            com.mpdc4gsr.component.shared.R.color.font_third_color,
                        )
                    },
                )
            }
