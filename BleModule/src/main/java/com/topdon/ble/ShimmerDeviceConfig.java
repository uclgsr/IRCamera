...
public class ShimmerDeviceConfig {
    ...
    public boolean isGSREnabled() { return enableGSR; }
    public boolean isPPGEnabled() { return enablePPG; }
    public boolean isIMUEnabled() { return enableIMU; }
    public int getGSRRange() { return gsrRange; }
    public int getPPGMode() { return ppgMode; }
