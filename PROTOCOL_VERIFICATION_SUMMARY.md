...
**Issue**: Verify the communication protocol, that when the PC sends commands, the app correctly passes it to the sensor and actually starts/stops the recording, does the settings, etc.
