...
class SessionController:
            ...
            while self.server_running:
                ...
                try:
                    ...
                    try:
                        ...
                        self.log_message(f"Invalid JSON from {device_id}: {data.decode('utf-8', errors='ignore')}", "WARNING")
    ...
    def process_device_message(self, device_id: str, message: dict):
        ...
        if msg_type == 'status_update':
            ...
            self.log_message(f"Time sync complete for {device.device_name}: offset={device.time_offset_ms}ms, RTT={device.round_trip_time_ms}ms")
