...
class DeviceStatusWidget:
    ...
    def __init__(self, parent):
        ...
        self.tree = ttk.Treeview(self.frame, columns=('Name', 'Type', 'Status', 'Recording', 'Data Count'),
...
class EnhancedGUIController:
    ...
    def setup_export_panel(self, parent):
        ...
        ttk.Radiobutton(format_frame, text="CSV", variable=self.export_format, value="csv").pack(side=tk.LEFT,
                                                                                                 padx=(10, 0))
        ...
        ttk.Checkbutton(options_frame, text="Include device information", variable=self.include_device_info).pack(
            anchor=tk.W)
        ...
        ttk.Button(export_btn_frame, text="Export All Data", command=self.export_all_data).pack(side=tk.LEFT,
                                                                                                padx=(10, 0))
