...
This document verifies that an Android phone (or simulation thereof) can successfully connect to the Python PC controller and exchange protocol messages.
...
1. **Advanced Protocol Commands**: Some commands (START_RECORD, STOP_RECORD) may need additional server-side handler implementation for full functionality
