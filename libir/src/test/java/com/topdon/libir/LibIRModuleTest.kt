...
class LibIRModuleTest {
    ...
    @Test
    fun testIRImageProcessing() = runTest {
        // Test IR image processing with mock thermal data
        val width = 80
        val height = 60
        val mockThermalData = Array(height) { row ->
    ...
    @Test
    fun testHotColdSpotDetection() = runTest {
    ...
    fun testThermalCalibration() = runTest {
        ...
        rawValues.forEach { rawValue ->
            ...
            assertTrue("Calibrated temperature should be reasonable", 
    ...
    @Test
    fun testIRImageFiltering() = runTest {
        // Test IR image filtering algorithms
        val size = 5
        val mockImage = Array(size) { row ->
            FloatArray(size) { col ->
    ...
    @Test
    fun testBitmapOperations() = runTest {
