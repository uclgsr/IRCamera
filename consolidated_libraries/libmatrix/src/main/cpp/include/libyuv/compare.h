...
HashDjb2(const uint8_t *src, uint64_t count, uint32_t seed);

LIBYUV_API
        uint64_t

ComputeHammingDistance(const uint8_t *src_a,
        const uint8_t *src_b,
        int count);
...
ComputeSumSquareError(const uint8_t *src_a,
        const uint8_t *src_b,
        int count);
...
ComputeSumSquareErrorPlane(const uint8_t *src_a,
        int stride_a,
        const uint8_t *src_b,
        int stride_b,
        int width,
...
LIBYUV_API
double SumSquareErrorToPsnr(uint64_t
sse,
uint64_t count
);
