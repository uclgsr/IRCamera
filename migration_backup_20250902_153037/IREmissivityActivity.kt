...
class IREmissivityActivity : BaseActivity() {
    ...
    private fun buildDataArray(): Array<ItemBean> =
        arrayOf(
            ...
            ItemBean(
                name = getString(R.string.material_polished_aluminum),
                minTemp = 100,
                emStr = "0.09"
            ),
            ItemBean(
                name = getString(R.string.material_comm_aluminum_foil),
                minTemp = 100,
                emStr = "0.09"
            ),
            ItemBean(
            ...
            ItemBean(
                name = getString(R.string.material_alumina),
                minTemp = 25,
                maxTemp = 600,
                emStr = "0.30～0.40"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_bronze_mirror),
                minTemp = 28,
                emStr = "0.03"
            ),
            ItemBean(
                name = getString(R.string.material_oxide),
                minTemp = 200,
                maxTemp = 600,
                emStr = "0.59～0.61"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_bronze_mirror_1),
                minTemp = 100,
                emStr = "0.05"
            ),
            ItemBean(
                name = getString(R.string.material_copper_oxide),
                minTemp = 25,
                emStr = "0.078"
            ),
            ItemBean(
            ...
            ItemBean(
                name = getString(R.string.material_golden_mirror),
                minTemp = 230,
                maxTemp = 630,
                emStr = "0.02"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_polished_cast_iron),
                minTemp = 200,
                emStr = "0.21"
            ),
            ItemBean(
                name = getString(R.string.material_process_cast_iron),
                minTemp = 20,
                emStr = "0.44"
            ),
            ItemBean(
                name = getString(R.string.material_full_rusty_surface),
                minTemp = 20,
                emStr = "0.69"
            ),
            ItemBean(
                name = getString(
                    R.string.material_cast_iron_oxidation,
            ...
            ItemBean(
                name = getString(R.string.material_cast_iron_oxygen),
                minTemp = 25,
                emStr = "0.8"
            ),
            ItemBean(
                name = getString(R.string.material_melt_surface),
                minTemp = 22,
                emStr = "0.94"
            ),
            ItemBean(
            ...
            ItemBean(
                name = getString(R.string.material_oxide_steel),
                minTemp = 100,
                emStr = "0.74"
            ),
            ItemBean(
            ...
            ItemBean(
                name = getString(R.string.material_pure_lead),
                minTemp = 125,
                maxTemp = 225,
                emStr = "0.06～0.08"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_mercury),
                minTemp = 0,
                maxTemp = 100,
                emStr = "0.09～0.12"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_plating_polished_nickel),
                minTemp = 25,
                emStr = "0.05"
            ),
            ItemBean(
                name = getString(R.string.material_nickel_not_polished),
                minTemp = 20,
                emStr = "0.01"
            ),
            ItemBean(
            ...
            ItemBean(
                name = getString(R.string.material_polished_silver),
                minTemp = 100,
                emStr = "0.05"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_eight_stainless_steel),
                minTemp = 25,
                emStr = "0.16"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_commercial_tin),
                minTemp = 100,
                emStr = "0.07"
            ),
            ...
            ItemBean(
                name = getString(
                    R.string.material_400c_zinc_oxide,
                    UnitTools.showWithUnit(400f)
                ), minTemp = 400, emStr = "0.01"
            ),
            ItemBean(
                name = getString(R.string.material_galvanized_brighter_iron_board),
                minTemp = 28,
                emStr = "0.23"
            ),
            ItemBean(
                name = getString(R.string.material_gray_zinc_oxide),
                minTemp = 25,
                emStr = "0.28"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_fire_brick),
                minTemp = 1100,
                emStr = "0.75"
            ),
            ItemBean(
                name = getString(R.string.material_graphite_black),
                minTemp = 96,
                maxTemp = 225,
                emStr = "0.95"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_asphalt),
                minTemp = 0,
                maxTemp = 200,
                emStr = "0.85"
            ),
            ItemBean(
                name = getString(R.string.material_glass_surface),
                minTemp = 23,
                emStr = "0.94"
            ),
            ItemBean(
            ...
            ItemBean(
                name = getString(R.string.material_lighting_groove_mica_capacitor),
                emStr = "0.90～0.93"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_crystal_tube_plastic_seal),
                emStr = "0.80～0.90"
            ),
            ...
            ItemBean(
                name = getString(R.string.material_pulse_transmission_coil),
                emStr = "0.91～0.92"
            ),
            ItemBean(
                name = getString(R.string.material_flat_white_layer_coil),
                emStr = "0.88～0.93"
            ),
