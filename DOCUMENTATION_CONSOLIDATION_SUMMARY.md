...
## Overview
Successfully consolidated IRCamera repository documentation from 28 to 25 markdown files, removing duplicates, outdated content, and ensuring ASCII safety.
