...
class ThermalComposeActivity : BaseComposeActivity<ThermalViewModel>() {
    ...
    override fun Content(viewModel: ThermalViewModel) {
        ...
        val features = remember(selectedTool) {
    ...
    private fun measurementTools(): List<ThermalTool> = listOf(
    ...
    private fun analysisTools(): List<ThermalTool> = listOf(
    ...
    private fun paletteTools(): List<ThermalTool> = listOf(
    ...
    private fun settingsTools(): List<ThermalTool> = listOf(
