...
Make sure the Topdon and Shimmer libs are fully used for the sensor integration, data streaming, data saving, device
settings, etc.

## Solution Overview

Enhanced both Topdon TC001/TC007 thermal camera SDK and Shimmer3 GSR sensor SDK integrations to utilize the full
capabilities of the libraries for comprehensive sensor operations.
...
All requirements specified in the issue have been addressed with production-ready implementations following Android and
Kotlin coding conventions, MVVM architecture, and repository pattern as per project guidelines.
