...
This implementation provides a comprehensive dual-mode camera system for Samsung S22 (Android 15)
and compatible devices, featuring fast session switching between RAW capture and 4K video recording
modes using Camera2 API.
...
This implementation provides a production-ready dual-mode camera system optimized for Samsung S22
devices while maintaining compatibility with the broader Android ecosystem.
